...
# Load the model
model_path = "../model_pkl/ShipEar/Cut_ShipEar_my_new.pkl"

model = audio_classification(16000,num_classes=5)
...
PATH = "../npz_data/noise/ShipEar/-10/10__10_07_13_101_2.npz"
...
def visualize_features(features, num_channels=6):
    ...
    plt.savefig("shipsear_conv5.pdf")
    plt.show()
